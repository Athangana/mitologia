...
const FIGURAS = [
 ...
 {id:"hemera", n:"Hémera", rol:"Primordial", epi:"El día", gen:"g1", padres:["erebo","nix"], pareja:["eter"],
  r:"La luz diurna en persona, hija de la tiniebla y de la noche: para los griegos el día nace de lo oscuro y no al revés. Hesíodo las sitúa a ella y a su madre en un mismo umbral que nunca cruzan juntas, saludándose al pasar mientras una entra y la otra sale."},
 {id:"eter", n:"Éter", rol:"Primordial", epi:"La luminosidad de las alturas", gen:"g1", padres:["erebo","nix"], pareja:["hemera"],
  r:"El aire superior, purísimo y encendido, que respiran los dioses, frente al aire denso y bajo que respiran los mortales. Es más sustancia del cielo que personaje con relatos propios; una tradición tardía lo une a Hémera y hace de ambos los padres de la tierra, el cielo y el mar."},
